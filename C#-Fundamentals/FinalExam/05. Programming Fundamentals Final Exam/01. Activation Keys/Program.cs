    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (command != "Generate")
            {
                ...
                {
                    case "Contains":
                        if (activationKey.IndexOf(tokens[1]) != -1)//ako go nameri
                        {
                    ...
                    case "Slice":
                        ...
                        activationKey = activationKey.Remove(startIndex, endIndex-startIndex);// ravnoto e zashtoto vrushta nov string i trqbva da se zapishe nqkude
                        Console.WriteLine(activationKey);
                        break;
