...
namespace _4._Password_Validator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            bool isTrue = ValidateLenght(password) && ValidateLetterAndDigirs(password) && PasswordHasTwoDigits(password);
            ...
            else
            {
                ...
                if (!ValidateLetterAndDigirs(password))
                {
        ...
        private static bool ValidateLetterAndDigirs(string password)
        {
            foreach (char c in password)
            {
